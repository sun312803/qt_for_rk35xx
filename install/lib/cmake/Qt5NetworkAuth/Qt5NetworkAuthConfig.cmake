...
if (NOT TARGET Qt5::NetworkAuth)
    ...
    set(Qt5NetworkAuth_PRIVATE_INCLUDE_DIRS
        "${_qt5NetworkAuth_install_prefix}/include/QtNetworkAuth/5.15.8"
        "${_qt5NetworkAuth_install_prefix}/include/QtNetworkAuth/5.15.8/QtNetworkAuth"
    )
    ...
    _populate_NetworkAuth_target_properties(RELEASE "libQt5NetworkAuth.so.5.15.8" "" FALSE)
