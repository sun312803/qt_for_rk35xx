...
if (NOT TARGET Qt5::Core)
    ...
    set(Qt5Core_PRIVATE_INCLUDE_DIRS
        "${_qt5Core_install_prefix}/include/QtCore/5.15.8"
        "${_qt5Core_install_prefix}/include/QtCore/5.15.8/QtCore"
    )
    ...
    set_property(TARGET Qt5::Core
                 ...
                 clock-gettime;datetimeparser;doubleconversion;futimens;getauxval;glibc;hijricalendar;inotify;linkat;mimetype-database;poll_ppoll;sha3-fast)
    set_property(TARGET Qt5::Core
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 etw;futimes;getentropy;glib;gnu-libiconv;iconv;icu;journald;lttng;system-pcre2;poll_poll;poll_pollts;poll_select;posix-libiconv;renameat2;slog2;statx;syslog;system-doubleconversion)
